    ...
    return (
        <div>
            ...
            <div onClick={()=>{
                ...
                <h2 className="text-xl font-semibold w-[20%]">${props.fare.car}</h2>
            </div>
            ...
            <div onClick={()=>{
                ...
                <h2 className="text-xl font-semibold w-[20%]">${props.fare.c_car}</h2>
            </div>
            ...
            <div onClick={()=>{
                ...
                <h2 className="text-xl font-semibold w-[20%]">${props.fare.motorcycle}</h2>
            </div>
            ...
            <div onClick={()=>{
                ...
                <h2 className="text-xl font-semibold w-[20%]">${props.fare.l_car}</h2>
            </div>
        </div>
    )
}
